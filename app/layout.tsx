...
export const metadata: Metadata = {
  title: "Barberking — Барбершоп Львів | вул. Шевченка 31А",
  description: "Преміальний барбершоп у Львові на вул. Шевченка 31А (ЖК Семицвіт). Чоловічі стрижки, догляд за бородою, королівське гоління та власна Tattoo Room. Безкоштовний паркінг, віскі-бар. Рейтинг 4.9 (674+ відгуків).",
  keywords: ["барбершоп львів", "стрижка бороди львів", "чоловіча стрижка шевченка", "barberking lviv", "тату салон львів", "королівське гоління"],
  icons: { icon: '/icon.svg' },
  openGraph: {
    title: "Barberking — Чоловічий барбершоп у Львові",
    description: "Стрижки, борода, королівське гоління та тату у Львові. Безкоштовний паркінг та преміальний бар.",
    type: "website",
    locale: "uk_UA",
  },
};
