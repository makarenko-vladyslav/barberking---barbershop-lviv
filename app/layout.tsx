...
export const metadata: Metadata = {
  title: "Barberking — Барбершоп Львів | Чоловічі стрижки та борода",
  description: "Преміальний барбершоп у Львові на вул. Шевченка 31А. Професійні чоловічі стрижки, модельне оформлення бороди, королівське гоління та окрема Tattoo Room.",
  keywords: ["барбершоп львів", "чоловіча стрижка львів", "стрижка бороди львів", "barberking львів", "барбер шевченка львів", "тату салон львів"],
  icons: {
    icon: "/icon.svg",
  },
  openGraph: {
    title: "Barberking — Барбершоп Львів",
    description: "Сучасний чоловічий барбершоп на вул. Шевченка 31А. Власний безкоштовний паркінг, напої, потрійна стерилізація.",
    type: "website",
  },
};
  ...
  return (
    <html lang="uk">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Jost:wght@500;600;700;800&family=Rubik:wght@400;500;600&display=swap"
          rel="stylesheet"
        />
      ...
      <body className="antialiased bg-[hsl(220,22%,8%)] text-[hsl(38,15%,92%)]">
